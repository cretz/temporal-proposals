...
func genProtos() error {
	...
	apiDir := filepath.Join(nexusGoDir, "../api")
	...
	protocArgs := []string{
		"-I", apiDir,
		"--go_out", nexusGoDir,
		"--go_opt", "module=github.com/nexus-rpc/sdk-go",
		"--go-grpc_out", nexusGoDir,
		"--go-grpc_opt", "module=github.com/nexus-rpc/sdk-go",
		"--grpc-gateway_out", nexusGoDir,
		"--grpc-gateway_opt", "module=github.com/nexus-rpc/sdk-go",
	}
	for _, proto := range backendProtos {
		relProto := strings.TrimPrefix(filepath.ToSlash(strings.TrimPrefix(proto, apiDir)), "/")
		arg := "M" + relProto + "=github.com/nexus-rpc/sdk-go/nexus/backend/backendpb"
